...
class CategoriesViewController: UIViewController {
    ...
    private lazy var fetchedResultsController: NSFetchedResultsController<Category> = {
        ...
        let fetchResult: NSFetchRequest<Category> = Category.fetchRequest()
        
        // Configure Fetch Request
        fetchResult.sortDescriptors = [NSSortDescriptor(key: "name", ascending: true)]
        
        // Create Fetched Results Controller
        let fetchedResultsController = NSFetchedResultsController(fetchRequest: fetchResult, managedObjectContext: managedObjectContext, sectionNameKeyPath: nil, cacheName: nil)
